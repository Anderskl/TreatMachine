...
#ifndef AccelStepperAKL_h
#define AccelStepperAKL_h
...
public:
    ...
    AccelStepperAKL(uint8_t interface = AccelStepperAKL::FULL4WIRE, uint8_t enablePin = 0xff, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5, bool enable = true);
    ...
    AccelStepperAKL(void (*forward)(), void (*backward)());
