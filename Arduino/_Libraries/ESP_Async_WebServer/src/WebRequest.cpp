...
bool AsyncWebServerRequest::_parseReqHead(){
  ...
  if(m == "GET"){
    _method = HTTP_GET_Async;
  } else if(m == "POST"){
    _method = HTTP_POST_Async;
  } else if(m == "DELETE"){
    _method = HTTP_DELETE_Async;
  } else if(m == "PUT"){
    _method = HTTP_PUT_Async;
  } else if(m == "PATCH"){
    _method = HTTP_PATCH_Async;
  } else if(m == "HEAD"){
    _method = HTTP_HEAD_Async;
  } else if(m == "OPTIONS"){
    _method = HTTP_OPTIONS_Async;
  }
...
const char * AsyncWebServerRequest::methodToString() const {
  if(_method == HTTP_ANY_Async) return "ANY";
  else if(_method & HTTP_GET_Async) return "GET";
  else if(_method & HTTP_POST_Async) return "POST";
  else if(_method & HTTP_DELETE_Async) return "DELETE";
  else if(_method & HTTP_PUT_Async) return "PUT";
  else if(_method & HTTP_PATCH_Async) return "PATCH";
  else if(_method & HTTP_HEAD_Async) return "HEAD";
  else if(_method & HTTP_OPTIONS_Async) return "OPTIONS";
  return "UNKNOWN";
}
